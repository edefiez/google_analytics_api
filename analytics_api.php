...
/*
 * This code is a fork of google analytics_api written by Chris Hope <chris@electrictoolbox.com> and made available
 *
...
//-------------------------------------------------------------------------------------------------
	...
	*/
	...
	//---------------------------------------------------------------------------------------------
		...
		foreach($entries as $entry) {
			...
			foreach($properties as $property) {
				$key = explode(':', $property->getAttribute('name'));
				$this->accounts[$idx][$key[1]] = $property->getAttribute('value');
			}
			$idx++;		
		}
	}
	...
	//---------------------------------------------------------------------------------------------
		...
		if(!$this->profileId)	throw new Exception("You must set your profile ID", 1);
		$id = $this->profileId;
